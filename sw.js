const CACHE='hanyang-study-pwa-v3-pc-guide';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./study_schedule.json','./lessons.html','./full_guide.pdf','./assets/icon-180.png','./assets/icon-192.png','./assets/icon-512.png'];
